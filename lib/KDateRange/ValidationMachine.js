...
/**
 * @params dateStr - The input date string value
 * @params lastAllowedDate - date passed to context object that
 * constrains dateStr to before this date
...
/**
 * @params dateStr - The input date string value
 * @params firstAllowedDate - date passed to context object that
 * constrains dateStr to after this date
